package com.attra.keycloakrestexample.userController;
...
import com.attra.keycloakrestexample.dto.UserDto;
...
public class UserController {
    ...
    private String realm = "keycloak-rest-sb";
    private String clientId = "keycloak-rest";
    //private String role = "student";
    //Get client secret from the Keycloak admin console (in the credential tab)
    private String clientSecret = "Ogm56DVNkiVbYGu2nbfByrM1cPlZsWbi";
    ...
    public ResponseEntity<?> createUser(@RequestBody  UserDto userDTO) {
        ...
        if (response.getStatus() == 201) {
           ...
           // RoleRepresentation realmRoleUser = realmResource.roles().toRepresentation();
